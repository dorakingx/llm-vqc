> **Inherited unchanged from v1** (`T1_capacity_controlled_v1`). The v2 primary VQC condition uses this exact space; only the experimental design around it (splits, seeds, baselines, ablations, statistics) changes. See `PROTOCOL.md`.
