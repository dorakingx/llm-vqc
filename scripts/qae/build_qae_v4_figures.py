"""Build the QAE v4 figures for the deck and paper from committed artifacts.

Inputs:  outputs/qae_tfim_neutral_v4/{selected_results.csv,anytime_mean.csv,
...
Axis language follows the v4 protocol: "held-out test trash fidelity
...
BASE = Path("outputs/qae_tfim_neutral_v4")
...
LEGEND = {
    ...
    "Greedy": "Greedy (no semantics, 4 warm starts + 4 refinements)",
    "LLM-Open": "LLM-Open (semantics, open-loop batch of 8)",
    "LLM-Closed": "LLM-Closed (semantics, 4 warm starts + 4 adaptive)",
}
